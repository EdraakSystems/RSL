...
/****** Object:  View [dbo].[AgentWise]    Script Date: 16/03/2022 3:03:14 pm ******/
SET ANSI_NULLS ON
GO
...
create view [dbo].[AgentWise] as 
SELECT 'Export' AS JobType,'Sea' AS Mode,
  VEN.FullName AS OverseasAgent, SEJM.JobDate, 
 ...
 UNION ALL
 SELECT  'Import' AS JobType,'Sea' AS Mode,   
   ven.FullName AS OverseasAgent,SIJM.JobDate,
 ...
 SELECT   'Export' AS JobType,'Air' AS Mode,  
  VEN.FullName AS OverseasAgent,AEJM.JobDate, 
 ...
 SELECT 'Import' AS JobType,'Air' AS Mode, 
  VEN.FullName AS OverseasAgent, AIJM.JobDate, 
 ...
 UNION ALL SELECT 'Road' AS JobType,'Transport' AS Mode, 
  VEN.FullName AS OverseasAgent, 
  TM.JobDate, 
  (AEChargesSum.Expense+AEChargesSum.ExpenseR) AS Expense,
  (AEChargesSum.Revenue+AEChargesSum.RevenueE) AS Revenue,
  ((AEChargesSum.Revenue+AEChargesSum.RevenueE)-(AEChargesSum.Expense+AEChargesSum.ExpenseR)) AS PL,
